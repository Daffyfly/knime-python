...
# Abstract base class for handling the execution of a specific command for the
# python kernel.
class CommandMessageHandler:
    ...
    # Get the associated CommandMessage
    def get_command_message(self):
        return self._command_message

    # Get the PayloadHandler for decoding the payload of the associated 
    # CommandMessage
...
# Factory method for a command handler able to handle an incoming CommandMessage.
# @param command_message and incoming command message
# @return the handler for the command message
