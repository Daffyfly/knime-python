 ...
 */
class PythonObjectInScriptOutNodeDialog extends DataAwareNodeDialogPane {
     ...
     */
    protected PythonObjectInScriptOutNodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(PythonObjectInScriptOutNodeConfig.getVariableNames(),
