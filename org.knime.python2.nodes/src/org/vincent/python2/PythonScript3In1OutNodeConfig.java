...
class PythonScript3In1OutNodeConfig extends PythonSourceCodeConfig {

    private static final VariableNames VARIABLE_NAMES = new VariableNames("flow_variables",
        new String[]{"input_table_1", "input_table_2", "input_table_3"}, new String[]{"output_table"}, null, null, null);
