 ...
 */
class Python2ScriptIn3OutNodeDialog extends DataAwareNodeDialogPane {
     ...
     */
    protected Python2ScriptIn3OutNodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(Python2ScriptIn3OutNodeConfig.getVariableNames(),
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        final Python2ScriptIn3OutNodeConfig config = new Python2ScriptIn3OutNodeConfig();
