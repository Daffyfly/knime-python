 ...
 */
package org.vincent.python2.view;
 ...
 */
class Python2View2NodeModel extends PythonNodeModel<Python2View2NodeConfig> {
     ...
     */
    protected Python2View2NodeModel() {
        super(new PortType[]{BufferedDataTable.TYPE,BufferedDataTable.TYPE}, new PortType[]{ImagePortObject.TYPE});
    }
    ...
    protected PortObject[] execute(final PortObject[] inData, final ExecutionContext exec) throws Exception {
        ...
        try (final PythonKernel kernel = new PythonKernel(getKernelOptions())) {
            kernel.putFlowVariables(Python2View2NodeConfig.getVariableNames().getFlowVariables(),
                getAvailableFlowVariables().values());
            kernel.putDataTable(Python2View2NodeConfig.getVariableNames().getInputTables()[0],
                (BufferedDataTable)inData[0], exec.createSubProgress(0.3));
            kernel.putDataTable(Python2View2NodeConfig.getVariableNames().getInputTables()[1],
                (BufferedDataTable)inData[1], exec.createSubProgress(0.3));
            ...
            image = kernel.getImage(Python2View2NodeConfig.getVariableNames().getOutputImages()[0]);
            final Collection<FlowVariable> variables =
                kernel.getFlowVariables(Python2View2NodeConfig.getVariableNames().getFlowVariables());
    ...
    @Override
    protected Python2View2NodeConfig createConfig() {
        return new Python2View2NodeConfig();
    }
