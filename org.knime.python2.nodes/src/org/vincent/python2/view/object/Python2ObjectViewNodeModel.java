 ...
 */
package org.vincent.python2.view.object;
 ...
 */
class Python2ObjectViewNodeModel extends PythonNodeModel<Python2ObjectViewNodeConfig> {
     ...
     */
    protected Python2ObjectViewNodeModel() {
        super(new PortType[]{PickledObjectPortObject.TYPE,PickledObjectPortObject.TYPE}, new PortType[]{ImagePortObject.TYPE});
    }
    ...
    protected PortObject[] execute(final PortObject[] inData, final ExecutionContext exec) throws Exception {
        ...
        try (final PythonKernel kernel = new PythonKernel(getKernelOptions())) {
            kernel.putFlowVariables(Python2ObjectViewNodeConfig.getVariableNames().getFlowVariables(),
                getAvailableFlowVariables().values());
            kernel.putObject(Python2ObjectViewNodeConfig.getVariableNames().getInputObjects()[0],
                ((PickledObjectPortObject)inData[0]).getPickledObject());
            kernel.putObject(Python2ObjectViewNodeConfig.getVariableNames().getInputObjects()[1],
                ((PickledObjectPortObject)inData[1]).getPickledObject());
            ...
            image = kernel.getImage(Python2ObjectViewNodeConfig.getVariableNames().getOutputImages()[0]);
            final Collection<FlowVariable> variables =
                kernel.getFlowVariables(Python2ObjectViewNodeConfig.getVariableNames().getFlowVariables());
    ...
    @Override
    protected Python2ObjectViewNodeConfig createConfig() {
        return new Python2ObjectViewNodeConfig();
    }
