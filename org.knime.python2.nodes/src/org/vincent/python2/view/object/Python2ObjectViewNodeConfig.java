...
class Python2ObjectViewNodeConfig extends PythonSourceCodeConfig {

    private static final VariableNames VARIABLE_NAMES = new VariableNames("flow_variables", null,
        null, new String[]{"output_image"}, new String[]{"input_object1","input_object2"}, null);
    ...
    protected String getDefaultSourceCode() {
        return "from io import BytesIO\n" + "# Only use numeric columns\n" + "data = "
                + VARIABLE_NAMES.getInputObjects()[0] + "._get_numeric_data()\n" + "# Replace row ID by number\n"
