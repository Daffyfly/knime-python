 ...
 */
public class Python2ObjectViewNodeView extends NodeView<Python2ObjectViewNodeModel> {
     ...
     */
    public Python2ObjectViewNodeView(final Python2ObjectViewNodeModel model) {
        super(model);
