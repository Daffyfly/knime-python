 ...
 */
class Python2ObjectViewNodeDialog extends DataAwareNodeDialogPane {
     ...
     */
    protected Python2ObjectViewNodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(Python2ObjectViewNodeConfig.getVariableNames(),
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        final Python2ObjectViewNodeConfig config = new Python2ObjectViewNodeConfig();
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs) throws NotConfigurableException {
        ...
        m_sourceCodePanel.updateData(new BufferedDataTable[0], new PickledObject[]{null, null});
        m_sourceCodeOptionsPanel.loadSettingsFrom(config);
    }
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObject[] input) throws NotConfigurableException {
        ...
        if (input[1] != null) {
            pickledObject1 = ((PickledObjectPortObject)input[1]).getPickledObject();
        }
        m_sourceCodePanel.updateData(new BufferedDataTable[0], new PickledObject[]{pickledObject,pickledObject1});
    }
