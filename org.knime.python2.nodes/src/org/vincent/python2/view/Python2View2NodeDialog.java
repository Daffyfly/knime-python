 ...
 */
class Python2View2NodeDialog extends DataAwareNodeDialogPane {
     ...
     */
    protected Python2View2NodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(Python2View2NodeConfig.getVariableNames(),
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        final Python2View2NodeConfig config = new Python2View2NodeConfig();
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final BufferedDataTable[] input)
        ...
        loadSettingsFrom(settings, new PortObjectSpec[]{input[1] == null ? null : input[1].getDataTableSpec()});
