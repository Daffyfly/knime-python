 ...
 */
class PythonTableToContextNodeDialog extends NodeDialogPane {
     ...
     */
    protected PythonTableToContextNodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(PythonTableToContextNodeConfig.getVariableNames(),
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        final PythonTableToContextNodeConfig config = new PythonTableToContextNodeConfig();
