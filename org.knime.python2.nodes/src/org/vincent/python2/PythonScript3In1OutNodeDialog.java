 ...
 */
class PythonScript3In1OutNodeDialog extends DataAwareNodeDialogPane {
     ...
     */
    protected PythonScript3In1OutNodeDialog() {
        m_sourceCodePanel = new PythonSourceCodePanel(PythonScript3In1OutNodeConfig.getVariableNames(),
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        final PythonScript3In1OutNodeConfig config = new PythonScript3In1OutNodeConfig();
